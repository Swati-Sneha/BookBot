...
def main():
	...
	show_genres_books=["show me books on", "read book on", "list me books for", "suggest me books on", "recommend me book on", "get me book from", "list some books on", "list a few books on	"]
